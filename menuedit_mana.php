...
<td><div class="td1"><input type="text" name="product_name" require></div></td>
<td><div class="td1"><input type="text" name="product_price" require></div></td>
<td><div class="td1"><input type="text" name="product_genre" require></div></td>
<td><div class="td1"><input type="text" name="product_description" require></div></td>
<td><div class="td1"><input type="text" name="is_featured" require></div></td>
